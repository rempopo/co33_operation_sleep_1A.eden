...
//игроки
kit_sprf_sl = [
	["<EQUIPEMENT >>  ","rhs_uniform_gorka_r_y","rhs_6b23_ML_6sh92_radio","RD_54_69_R148","rhs_altyn_novisor",""],
...
kit_spsf_mm = [
	["<EQUIPEMENT >>  ","rhs_uniform_gorka_r_y","rhs_6b23_sniper","rhs_sidor","H_Watchcap_khk","rhs_scarf"],
	["<PRIMARY WEAPON >>  ","rhs_weap_svds","rhs_10Rnd_762x54mmR_7N1",["rhs_acc_tgpv2","","rhs_acc_pso1m21",""]],
	["<LAUNCHER WEAPON >>  ","","",["","","",""]],
	["<HANDGUN WEAPON >>  ","rhs_weap_pb_6p9","rhs_mag_9x18_8_57N181S",["rhs_acc_6p9_suppressor","","",""]],
	["<ASSIGNED ITEMS >>  ", ASSIGNED_ITEMS_L],
	["<UNIFORM ITEMS >> ",[UNIFORM_ITEMS_L]],
	["<VEST ITEMS >> ",[["PRIMARY MAG",10],["rhs_mag_rgd5",2],["rhs_mag_rdg2_white",1],["HANDGUN MAG",1]]],
	["<BACKPACK ITEMS >> ",[["ACE_RangeCard",1],["ACE_Tripod",1],["ACE_EntrenchingTool",1],["PRIMARY MAG",10],["ACE_FlareTripMine_Mag",1],["HANDGUN MAG",1]]]
];
kit_sprf_ar = [
	...
	["<VEST ITEMS >> ",[["ACE_EntrenchingTool",1],["rhs_mag_rgd5",2],["rhs_100Rnd_762x54mmR_green",1],["rhs_mag_rdg2_white",1]]],
	["<BACKPACK ITEMS >> ",[["rhs_100Rnd_762x54mmR_green",2]]]
];
kit_sprf_gr = [
	["<EQUIPEMENT >>  ","rhs_uniform_gorka_r_y","rhs_6b23_6sh116_vog_od","","rhs_altyn_novisor",""],
	["<PRIMARY WEAPON >>  ","rhs_weap_ak74m_gp25","rhs_VOG25",["rhs_acc_dtk1983","","rhs_acc_1p78",""]],
	["<LAUNCHER WEAPON >>  ","","",["","","",""]],
	["<HANDGUN WEAPON >>  ","","",["","","",""]],
	["<ASSIGNED ITEMS >>  ", ASSIGNED_ITEMS],
	["<UNIFORM ITEMS >> ",[UNIFORM_ITEMS]],
	["<VEST ITEMS >> ",[["ACE_EntrenchingTool",1],["rhs_mag_rgd5",1],["PRIMARY MAG",9],["rhs_30Rnd_545x39_AK_green",10],["rhs_GDM40",1],["rhs_VG40MD_White",2]]],
	["<BACKPACK ITEMS >> ",[]]
];
kit_sprf_at = [
...
kit_sprf_ftl = [
	["<EQUIPEMENT >>  ","rhs_uniform_gorka_r_y","rhs_6b23_6sh92_radio","CUP_B_AlicePack_Khaki","rhs_altyn_novisor",""],
	["<PRIMARY WEAPON >>  ","rhs_weap_ak74m_2mag","rhs_30Rnd_545x39_AK_green",["rhs_acc_dtk","rhs_acc_2dpZenit","rhs_acc_1p78",""]],
	["<LAUNCHER WEAPON >>  ","","",["","","",""]],
	["<HANDGUN WEAPON >>  ","rhs_weap_makarov_pm","rhs_mag_9x18_8_57N181S",["","","",""]],
	["<ASSIGNED ITEMS >>  ", ASSIGNED_ITEMS_L],
	["<UNIFORM ITEMS >> ",[UNIFORM_ITEMS_L]],
	["<VEST ITEMS >> ",[["PRIMARY MAG",6],["rhs_mag_rgd5",2],["HANDGUN MAG",2],["rhs_mag_rdg2_white",2]]],
	["<BACKPACK ITEMS >> ",[["ACE_EntrenchingTool",1],["ACE_personalAidKit",1],["ACE_HandFlare_Red",1],["ACE_HandFlare_Green",1],["ACE_HandFlare_White",1],["rhs_mag_rdg2_white",1],["rhs_mag_rdg2_black",1],["PRIMARY MAG",7],["rhs_rpg7_PG7VL_mag",1],["rhs_100Rnd_762x54mmR_green",1]]]
];
